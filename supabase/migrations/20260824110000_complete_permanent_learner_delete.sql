-- Ensure permanent learner deletion removes every learner-owned record,
-- including records added by the senior-school and finance modules.
...
BEGIN
  ...
  -- Delete child rows before the learner and before their financial parents.
  DELETE FROM public.student_learning_area_enrollments
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.student_pathway_assignments
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.student_pathway_preferences
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.senior_pathway_change_audit
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.tvet_transitions
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.learner_guardians
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.enrollments
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.learner_status_history
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.student_class_history
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.student_status_history
    WHERE school_id = _school_id AND learner_id = _learner_id;
  DELETE FROM public.student_exit_records
    WHERE school_id = _school_id AND learner_id = _learner_id;
