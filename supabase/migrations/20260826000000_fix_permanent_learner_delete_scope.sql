-- Ensure permanent learner deletion removes the full learner record graph.
-- This includes academic history, class history, senior-school pathway data,
-- fee and ledger records, and the learner themselves.
